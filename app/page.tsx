    ...
    <main className="page">
      ...
      <section className="hero">
        ...
        <div className="hero-shell">
          <header className="hero-nav">
            <a href="#top" className="brand" id="top" aria-label="Manageable homepage">
      ...
      <section className="pain">
        ...
        <p className="pain-lead">
          Small delays in field reporting quickly become costly blind spots for management decisions.
        </p>
      ...
      <section className="authority">
        <div className="authority-inner">
          <div className="authority-copy">
            ...
            <h2>We do not just sell software. We help run the digitization with you.</h2>
            <p>
              Manageable combines platform + execution support so your team gets adoption, working workflows, and measurable
          ...
          <div className="authority-grid">
            <article className="authority-card card-1">
              ...
              <p>Hands-on support labour to implement, configure, and stabilize reporting operations end-to-end.</p>
            ...
            <article className="authority-card card-2">
              ...
              <p>We tailor workflows to your current project execution model, not a generic template.</p>
              <div className="authority-icons authority-icons-centered" aria-hidden="true">
            ...
            <article className="authority-card card-3">
              ...
              <p>Early partners get founder-stage pricing with high-value rollout scope while slots remain open.</p>
              <div className="authority-icons authority-icons-centered" aria-hidden="true">
            ...
            <article className="authority-card card-4">
              ...
              <p>We keep improving your digital operations after go-live so the system keeps compounding value.</p>
              <div className="authority-icons authority-icons-centered" aria-hidden="true">
          ...
          <div className="authority-offer">Founders Program: limited onboarding slots with priority support.</div>
        </div>
      </section>
      ...
      <section className="strong-cta" id="book-demo">
        <div className="strong-cta-head">
          ...
          <p className="cta-subhead">Book an appointment or send us an email for a demo.</p>
        </div>
